...
exports.healthTools = [
    {
        ...
        handler: async ({ strapi }) => {
            ...
            return {
                ...
                strapi_version: (_c = (_b = (_a = strapi.config) === null || _a === void 0 ? void 0 : _a.info) === null || _b === void 0 ? void 0 : _b.strapi) !== null && _c !== void 0 ? _c : "unknown",
                ...
                node_env: (_d = process.env.NODE_ENV) !== null && _d !== void 0 ? _d : "development",
                hint: uptimeSeconds < 30
